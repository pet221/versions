...
# outputFileName = "c:\\projects\\python\\data\\work\\LSN1\\ComplexConf.txt"
# lsnWorkspace = "c:\\projects\\python\\data\\work\\LSN1\\lsn1.mdb" #pathname to the geodatabase that contains the LSN
