...
try:
   ...
   # InputEdges = "c:\\projects\\python\\data\\example_final\\lsn1\\lsn1.mdb\\edges"    # Input Feature Class
   # accumAttList = "h2oAreaKm2"
   # localFieldList = "rcaAreakm2"
   # newFieldList = "test2"
   # string = "c:\\projects\\python\\data\\example_final\\lsn1\\lsn1.mdb\\sites;c:\\projects\\python\\data\\example_final\\lsn1\\lsn1.mdb\\preds"
