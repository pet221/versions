...
if __name__ == "__main__":
    try:
        ...
        # edges_path = "c:/projects/python/data/example_final/lsn1/lsn1.mdb/edges" # Landscape Network Featureclass
        # areaFieldname = "h2oAreaKm2" # field that PI will be based on
        # strPropFieldName = "ap2" # new or existing field that will be populated with PI
