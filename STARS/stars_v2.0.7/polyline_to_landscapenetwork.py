#--------------------------------------------------------------------------#
# The Polyline to Landscape Network tool is used to convert a shapefile
# of streams data to a LSN. Shapefiles of nodes and edges are created in a
# personal geodatabase. Edges are assigned a reach identifier (rid) and
# nodes a pointid. Topological relationships are stored in the nodexy,
# noderelationships, and relationships tables.
#--------------------------------------------------------------------------#
# Created by John Norman and David M. Theobald
# Last updated by Erin Peterson 04/24/17
...
if __name__ == "__main__":
    ...
    # Create Geodatabase and tables nessary to make a LSN
    # create Grodatabase
    gp.AddMessage(" ")
