...
##        SamplePTS = r"d:/temp/sites1.shp"  # Sample points to snap to network
##        EdgeNetwork = r"d:/temp/lsn100.mdb/edges" # Network to snap sample points to
##        OutPutFC = r"d:temp/lsn100.mdb/sites8" # Output snapped points name and location -> this should be a featureclass in a PGDB
