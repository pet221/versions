...
##    searchDist = sys.argv[4] # this is the search distance
    ...
    NodeFC = "d:\\temp\\example8\\lsn1\\lsn1.mdb\\nodes"    # Input Feature Class
    OutField = "node_cat"  # field to attribute
    EdgeFC = "d:\\temp\\example8\\lsn1\\lsn1.mdb\\edges"     # field to accumulate on
    searchDist = 75 # this is the search distance
