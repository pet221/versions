...
##    InDEM = "d:\\projects\\spatpred\\gisdata\\scdata\\filldem10"   # DEM Raster Layer         
##    InFlowDir = "d:\\projects\\spatpred\\gisdata\\scdata\\burnfd10"        # Flow Direction Raster Layer 
##    InReach = "d:\\projects\\spatpred\\gisdata\\scdata\\strmgrid1"           # Reach Raster Layer
##    InWaterBody = "d:\\projects\\spatpred\\gisdata\\scdata\\wbgrid1"       # Water Body Raster Layer
##    OutHCAshapefile = "d:\\projects\\spatpred\\gisdata\\scdata\\sca1.shp"   # Output shapefile name and location
##    WKSpace = "c:\\temp"
    ...
    if InWaterBody <> "#":
        ...
        string = "seed10 = merge(burntemp, " + InReach + ")"
        gp.MultiOutputMapAlgebra(string)
    ...
    x = 1
    iterations = 5
    gp.AddMessage("Creating RCA Rasters....")
    gp.AddMessage("   ")    
    while x < iterations:
        ...
        #gp.Command("RegionGroup " + holesnull + " " + holesreg + " FOUR WITHIN NO_LINK")
    ...
    #gp.Dissolve_management("temp_rca.shp", OutHCAshapefile, "GRIDCODE", "#", "MULTI_PART")    

    # Process: Add Field...
    gp.AddField_management(OutHCAshapefile + ".shp", "rca_id", "LONG", "16", "", "", "", "NON_NULLABLE", "NON_REQUIRED", "")
    #gp.AddField_management(OutHCAshapefile, "rca_id", "LONG", "16", "", "", "", "NON_NULLABLE", "NON_REQUIRED", "")
    ...
    #gp.CalculateField_management(OutHCAshapefile, "rca_id", "[GRIDCODE]")
