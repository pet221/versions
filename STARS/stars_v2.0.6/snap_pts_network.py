...
# Last updated by Erin Peterson 004/24/17

import arcgisscripting, sys, string, os, re, time, math, arcpy
from time import *
...
if __name__ == "__main__":
    ...
    try:    
        ...
        TempWorkspace  = sys.argv[5] # temporary workspace
        ...
        # Added by D. Nagel, 4-20-15.
        # Obtain spatial reference in order to define projection for output data
        ...
        tempSHP = TempWorkspace + "\\snaptemp.shp"
        ...
        while row:
            ...
            if FID <> -1:
                ...
                for pointField in pointFields: # populate fields input point feature class attributres
                    if count > 2: # # Added by D. Nagel, 4-20-15. Changed > 3 to > 2.
        ...
        arcpy.CopyFeatures_management(tempSHP, OutPutFC)
